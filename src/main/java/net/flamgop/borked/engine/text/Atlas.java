...
import net.flamgop.borked.engine.PlortCommandPool;
import net.flamgop.borked.engine.PlortDevice;
import net.flamgop.borked.engine.image.Format;
import net.flamgop.borked.engine.memory.TrackedCloseable;
import net.flamgop.borked.engine.image.PlortImage;
import net.flamgop.borked.engine.image.PlortSampler;
import net.flamgop.borked.engine.memory.*;
import net.flamgop.borked.engine.text.json.JsonAtlasFile;
import net.flamgop.borked.engine.text.json.JsonGlyph;
...
public class Atlas extends TrackedCloseable {
    ...
    public Atlas(PlortDevice device, PlortAllocator allocator, PlortCommandPool commandPool, String atlasPath) {
        ...
        this.bakedGlyphData = new PlortBuffer(BAKED_GLYPH_SIZE * numGlyphs, VK_BUFFER_USAGE_STORAGE_BUFFER_BIT, allocator);
        ...
        try (MemoryStack stack = MemoryStack.stackPush()) {
            ...
            PlortBuffer stagingBuffer = new PlortBuffer(imageData.capacity(), VK_BUFFER_USAGE_TRANSFER_SRC_BIT, allocator);
